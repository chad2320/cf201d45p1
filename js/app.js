...
// var userFix = prompt('Please reenter your choice using a number. The options are in numerical order. /br Choices:' + spellCheck2.join());
// var finalAnswer = spellCheck2[(userFix +1)];
