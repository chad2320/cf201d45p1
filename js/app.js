...
//   alert('Nice! Not going to lie I am a bit envious!');
...
// var numberPrompt = prompt('Whats my favorite number?');
// var correctNumber = 13;

// for(var d = 0;d < 4;d++){
//   if(numberPrompt === correctNumber){
//     alert('Wow good job! Your right!');
//     break;
//   } else if(numberPrompt > 13){
//     numberPrompt = prompt('To high! ' + (3 - d) + ' guesses left!');
//   } else if(numberPrompt < 13){
//     numberPrompt = prompt('To low! ' + (3 - d) + ' guesses left!');
//   } else {
//     numberPrompt = prompt('Uhhh something went wrong. Try again?');
//   }
// }
...
// if(correct === 7){
//   alert('Congrats your the sharpest knife in the drawer! ' + correct + ' out of 7!');
// } else if(correct >= 4 && correct < 7){
//   alert('You got your head on right today ' + correct + ' out of 7 correct! Not bad!');
// } else {
//   alert('Oof! ' + correct + ' out of 7. Better luck next time!');
// }
